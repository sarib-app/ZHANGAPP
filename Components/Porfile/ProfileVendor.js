...
import { View, Text, FlatList ,Image,ScrollView, ImageBackground,TouchableHighlight, Pressable, TouchableOpacity, Alert } from 'react-native';
...
import GetVendorData from '../GlobalCalls/Vendor/GetVendorData';
const ProfileVendor = () => {
...
const [user,setUser]=useState(
  {
      id:"Couldn't load",
      shop_name:"Couldn't load",
      phone_number:"Couldn't load",
  }
)
