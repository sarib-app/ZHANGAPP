...
import PostProduct from '../../GlobalCalls/Vendor/PostProduct';
...
const AddProductScreen = () => {
  ...
  const handleAddProduct =async  () => {
    if(productName  && productPrice && selectedCategory  && productDescription 
      && addOns.length>0 && variations.length>0 && ProofImage
      ){
...
style={[styles.imageContainer,submit === true && !ProofImage && styles.dangerExpression]}
>
{
